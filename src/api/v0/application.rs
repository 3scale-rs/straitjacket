...
pub use crate::api::v0::account::application::*;

endpoint! { EP_LIST_ALL_APPLICATIONS, GET joining [ "/admin/api/applications.json" ] returning Applications }

#[cfg(test)]
mod tests {
    use super::*;

    endpoint_test! { it_parses, EP_LIST_ALL_APPLICATIONS, r##"{
      "applications": [
        {
          "application": {
            "id": 1409618117181,
            ...
            "updated_at": "2020-07-20T11:24:23+01:00",
            ...
            "first_daily_traffic_at": "2020-07-20T11:24:00+01:00",
